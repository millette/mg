  ...
  return Promise.all(x.body.rows.map((y) => {
    ...
    if (y.error || y.value.deleted) {
      ...
      return got(y.key, { encoding: null })
        .then((z) => {
          // console.log('z:', Object.keys(z))
          // console.log('z:', z.headers)
          // insert image in db

/*
          const mm = makeMultipart(z)
          console.log('mm.headers:', mm.headers)
          const it = {
            json: true,
            headers: mm.headers,
            body: mm.str
...
*/
          ...
          console.log('typeof z.body:', typeof z.body)
